 ...
 * Description:
 */
public class DefaultHttpClientRf {
    private static final String TAG = "DefaultHttpClient";

    private static DefaultHttpClientRf mInstance;
    ...
    public static DefaultHttpClientRf getInstance() {
        if (mInstance == null) {
            synchronized (DefaultHttpClientRf.class) {
                if (mInstance == null) {
                    mInstance = new DefaultHttpClientRf();
                }
            }
        }
        return mInstance;
    ...
    private void deliveryRequest(ResultCallback callback, Request request) {
        if (callback == null) {
